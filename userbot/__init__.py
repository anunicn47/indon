...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/ez69bw/ezbw.git")
    ...
    try:
        ...
        async def handler(event):
            if event.message.from_id != uid:
                await event.reply("𝙚𝙯𝙗𝙬, Buat Userbot Mu Sendiri [Tekan Disini](https://github.com/ez69bw/ezbw.git)")
            else:
                await event.reply(f"`Hii {ALIVE_NAME}\n\nApa Kabar?`")
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@UserButt"):
                ...
                result = builder.article(
                    "**𝙚𝙯𝙗𝙬**",
                    text="""**Anda Bisa Membuat 𝙚𝙯𝙗𝙬 Anda Sendiri Dengan Cara:** [Tekan Disini](https://github.com/ez69bw/ezbw)"""",
                    buttons=[
                        [
                            custom.Button.url(
                                "REPO",
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:  # pylint:disable=E0602
                ...
                reply_pop_up_alert = f"Harap Deploy 𝙚𝙯𝙗𝙬 Anda Sendiri, Jangan Menggunakan Milik {ALIVE_NAME}!!"
